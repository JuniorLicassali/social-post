...
VALUES
('1', 'socialpost-backend', '2024-10-19 22:18:57', '$2a$12$xynnsPaCuu4mO3vhbC4jq.mO15Eha.tm5Y89SSbKKhu.KG72P2VZK', NULL, 'SocialPost Backend', 'client_secret_basic', 'client_credentials', '', 'READ', 
...
(id, client_id, client_id_issued_at, client_secret, client_secret_expires_at, client_name, client_authentication_methods, authorization_grant_types, redirect_uris, scopes, client_settings, token_settings)
VALUES
('2', 'socialpostweb', '2024-10-19 22:18:58', '$2a$12$qdd1cFflV1NOuEUm2.krs.jiEdTe9UZGzobTLNPfSYsNPAeTI4f8C', NULL, 'SocialPost Web', 'client_secret_basic', 'refresh_token,authorization_code', 
'http://127.0.0.1:8080/authorized,http://127.0.0.1:8080/swagger-ui/oauth2-redirecr.html', 'READ,WRITE', 
...
(id, client_id, client_id_issued_at, client_secret, client_secret_expires_at, client_name, client_authentication_methods, authorization_grant_types, redirect_uris, scopes, client_settings, token_settings)
VALUES
('3', 'socialpostanalytics', '2024-10-19 22:18:58', '$2a$12$qdd1cFflV1NOuEUm2.krs.jiEdTe9UZGzobTLNPfSYsNPAeTI4f8C', NULL, 'SocialPost Analytics', 'client_secret_basic', 'authorization_code', 
'http://aplicacaocliente:8082', 'READ,WRITE', 
'{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":false}', 
